...
import logo from "../assets/l0.png";
  ...
  return (
    <>
      <header
        className={
          !navState
            ? "absolute top-5 left-0 right-5 opacity-100 z-50"
            : "fixed   top-0 left-0 right-0 h-[14vh] flex items-center justify-center opacity-100 z-[200] blur-effect-theme"
        }
      >
          ...
          <div className="flex items-center ">
            <img
              ...
              className={`w-16 h-16 m-5 rounded-full ${
                navState && "filter brightness-3"
              }`}
            />
            <h1 className=" text-1xl font-extrabold filter drop-shadow-sm text-slate-500">
              Shoes Store
            </h1>
          </div>
